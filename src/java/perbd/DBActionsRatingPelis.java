...
public class DBActionsRatingPelis {
    ...
    public String getPelisDeRating(String par) {
        ...
        try {
            ...
            String sqlq = "select * from ratingpelis where ((ratio >= " + a + ") and (ratio <= " + A + ")) order by ratio desc limit 100";
    ...
    public List<String> getPelisDeRatingString(String par) {
        DBConnection con = new DBConnection();
    ...
    public int getPelisDeRatingCount(String par) {
        DBConnection con = new DBConnection();
        List<String> res = new ArrayList<>();
        float a = Float.parseFloat(par.substring(0, par.indexOf("-")));
        float A = Float.parseFloat(par.substring(par.indexOf("-") + 1));
