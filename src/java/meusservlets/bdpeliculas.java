...
public class bdpeliculas extends HttpServlet {
    ...
    private String gestionPeticion(HttpServletRequest request) {
        ...
        } else if (operacion.contentEquals("pelisderatingstring"))
        {
            DBActionsRatingPelis dbapp = new DBActionsRatingPelis();
            res = dbapp.getPelisDeRatingString(par).toString();
        } else if (operacion.contentEquals("pelisderatingcount"))
        {
            DBActionsRatingPelis dbapp = new DBActionsRatingPelis();
            res = Integer.toString(dbapp.getPelisDeRatingCount(par));
        } else if (operacion.contentEquals("getMoviesInfo"))
        {
